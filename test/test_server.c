...
//   echo_server* server = make_echo_server(addr, BACKLOG_SIZE);
...
// // No tests for accept, as it involves forking behavior that is a bit tough
// to
// // handle in a unit test.

// // echo will be tested separately, as it involves setting up a server and
// // client.
